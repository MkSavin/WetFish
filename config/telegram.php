...
return [
    ...
    */
    'commands'                     => [
        ...
        App\Telegram\Commands\CurrentCommand::class,
        App\Telegram\Commands\FirstQuestionCommand::class,
        App\Telegram\Commands\AnswerCommand::class,
        App\Telegram\Commands\HintCommand::class,
        App\Telegram\Commands\ObserveCommand::class,
    ],
